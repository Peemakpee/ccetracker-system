<template>
  ...
  <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
      <div class="text-3xl font-bold sm:px-6 lg:px-40 hidden sm:block">
        Table of Specifications (TOS)
      </div>
      <div class="ml-40 py-1 border-b-2 w-full border-black hidden sm:block"></div>
      <br>
      <div class="ml-40">
        <div class="py-1 text-md text-center font-bold rounded-t-lg" style="background-color: #CFAE46; opacity: 1">
          Available TOS Templates
        </div>
...
export default {
  ...
  methods: {
    async listFiles() {
      const folderRef = ref(storage, 'deliverables_template/TOS');
